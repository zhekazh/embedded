...
- `digitalWrite(pin, HIGH/LOW)` = запис біта в регістр GPIO. ⤳ на регістрах STM32 — M5.
- Дебаг прошивки = `GDB ↔ симульований чіп`; на залізі праву частину підніме OpenOCD + ST-Link. ⤳ M6.
